...
latitude = '<LATITUDE>' # Set this if IP location lookup does not work for you (must be a string)
longitude = '<LONGITUDE>' # Set this if IP location lookup does not work for you (must be a string)
xlarge_text_size = 94
large_text_size = 48
medium_text_size = 32
small_text_size = 22
